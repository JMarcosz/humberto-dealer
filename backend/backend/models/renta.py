...
class CoberturaSeguro(db.Model):
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "deposito_requerido": float(self.deposito_requerido),
...
class ReservaRenta(db.Model):
    ...
    def to_dict(self, include_detalle: bool = True) -> dict:
        v = self.vehiculo
        ...
        data = {
            ...
            "conductor": {
                ...
                "documento": self.conductor_documento,
                "licencia": self.conductor_licencia,
                "fecha_nacimiento": self.conductor_fecha_nac.isoformat() if self.conductor_fecha_nac else None,
            },
