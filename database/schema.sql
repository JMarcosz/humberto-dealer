...
CREATE TABLE vehiculos (
    ...
    disponible_para     ENUM('VENTA','RENTA','AMBOS') NOT NULL DEFAULT 'AMBOS',
    pasajeros           SMALLINT NOT NULL DEFAULT 5,
    maletas_grandes     SMALLINT NOT NULL DEFAULT 2,
    maletas_pequenas    SMALLINT NOT NULL DEFAULT 2,
    tiene_aire_acondicionado TINYINT(1) NOT NULL DEFAULT 1,
